...
import { ReactComponent as ChevronTopRightIcon } from "../../assets/icons/chevron-top-right.svg";
...
function RecipeDetail() {
    ...
    const togglePicked = () => {
        ...
        axios
            ...
            .then((response) => {
                setLike((prevCount) =>
                    picked ? prevCount - 1 : prevCount + 1
                );
                setPicked(!picked);
            })
            .catch((error) => {
                    ...
                    <div className="grd-tags">
                        {recipe.ingredients.map((ingredient) => (
                            <div className="grd-tag">
                                ...
                                <ChevronTopRightIcon className="grd-chevron-icon" />
                                <div className="grd-amount">
                                    {ingredient.amount}개
                                </div>
                            </div>
                        ))}
